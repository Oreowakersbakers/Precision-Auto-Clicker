...
- Moved source-of-truth planning docs into `docs/` while keeping runtime modules, launcher scripts, build scripts, packaging config, references, and `AGENTS.md` at the repository root.
